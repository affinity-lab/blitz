...
export abstract class ITagRepository<S extends Record<string, any> = any, T extends MySqlTableWithColumns<any> = any, TM extends ITagManager = any> extends MySqlRepository<S, T> {
	...
	abstract getByName(...args: any): MaybePromise<Array<any & {id: number}>>;
	abstract getOneByName(...args: any): MaybePromise<any & {id: number}>;
	abstract getByNameNonPredefined(...args: any): MaybePromise<Array<any & {id: number}>>;
}
